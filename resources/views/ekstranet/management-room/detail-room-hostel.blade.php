                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <a href="#"
                                        class="text-gray-100 text-hover-primary fs-1 fw-bold me-1">{{ $hostelrooms->hostel->name }}</a>
                                </div>
                                <div class="d-flex align-items-center mb-2">
                                    <a href="#"
                                        class="text-gray-100 text-hover-primary fs-2 fw-semibold me-1">{{ $hostelrooms->name }}
                                        Room</a>
                                </div>
                                <!--end::Name-->
                                <!--begin::Info-->
                            ...
                            <div class="d-flex my-4 flex-column mt-15 m-5">
                                ...
                                <span class="fw-semibold fs-7 ">Terdapat {{ $hostelrooms->totalroom }} Ruangan Pada Tipe
                                    Kamar Ini</span>
                                <!--begin::Menu-->
                        ...
                        <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
                            <div class="row">
                                ...
                                <table class="table-row-dashed fs-6 gy-5 table-bordered table align-middle"
                                    ...
                                    <tbody>
                                        @foreach ($hostelrooms->hostelroomimage as $roomimage)
                                            <tr>
                                        ...
                                        @endforeach
                                        @include('ekstranet.management-room.edit-image-room-hostel')
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_target_form" class="form" method="post"
                        action="{{ route('partner.management.room.storehostelroomImage') }}"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="hostel_id" value="{{ $hostelrooms->hostel->id }}">
                        <input type="hidden" name="hostel_room_id" value="{{ $hostelrooms->id }}">
