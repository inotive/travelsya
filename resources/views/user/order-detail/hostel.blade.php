                                    ...
                                    <div class="col-12 mb-5">
                                        ...
                                        <div class="card border border-1 mb-5">
                                            ...
                                            <div class="m-5 d-flex align-items-center">
                                                ...
                                                <div class="symbol symbol-75px"
                                                    ...
                                                    <img src="{{ asset($imagePath) }}" alt="hostel-main">
                                                </div>
                                            ...
                                            <div class="fs-6 m-5 mt-0 d-flex flex-wrap">
                                                @forelse ($roomFacilities as $facility)
                                                    <div class="text-bold" style="margin-right: 8px">
                                                        {{ ucfirst($facility->facility_name) }}</div>
                                                @empty
                                                    Tidak ada fasilitas
                                                @endforelse
                                            </div>
                                        ...
                                        <div class="card border border-1 mb-5">
                                            ...
                                            <div class="m-5">
                                                ...
                                                <div class="d-flex mb-1 justify-content-between">
                                                    ...
                                                    <div class="fs-8 fw-bold">{{ $transactionHostel->guest_handphone }}
                                                    </div>
                                                </div>
                                                <div class="d-flex mb-1 justify-content-between">
                                        ...
                                        <div class="card border border-1 mb-5">
                                            ...
                                            <div class="d-flex justify-content-between m-5">
                                                ...
                                                <a href="https://maps.google.com/?q={{ $transactionHostel->hostel->lat }},{{ $transactionHostel->hostel->lon }}"
                                            ...
                                            <div class="m-5">
                                                ...
                                                <div class="d-flex mb-1 justify-content-between">
                                                    ...
                                                    <div class="fs-8 fw-bold">
                                                        {{ \Carbon\Carbon::parse($transactionHostel->transaction->created_at)->format('d M Y H:i') }}
                                                    </div>
                                                </div>
                                                <div class="d-flex mb-1 justify-content-between">
                                                    <div class="fs-8">Metode Pembayaran</div>
                                                    <div class="fs-8 fw-bold">
                                                        {{ str_replace('_', ' ', $transactionHostel->transaction->payment_method) }}
                                                    </div>
                                                </div>
                                                <div class="d-flex mb-1 justify-content-between">
                                                ...
                                                <div class="d-flex mb-1 justify-content-between">
                                                    ...
                                                    <div class="fs-8 fw-bold">
                                                        {{ number_format($transactionHostel->fee_admin + $transactionHostel->kode_unik, 0, ',', '.') }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
