                                        ...
                                        <div class="row my-4">
                                            ...
                                            <div class="col-6">
                                                <div class="row gy-4">
                                                    ...
                                                    <div class="col-12">
                                                        <p>{{ $hostel->address ?? 'Jln. Mekar Sari RT. 19 NO. 67 Gn. Sari Ilir, Balikpapan' }}
                                                        </p>
                                                    </div>
                                                    <div class="col-12">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <a href="{{ route('hostel.room', $hostel->id) . '?location=' . $_GET['location'] . '&start=' . $_GET['start'] . '&duration=' . $_GET['duration'] . '&room=' . $_GET['room'] . '&guest=' . $_GET['guest'] . '&property=' . $_GET['property'] . '&roomtype=' . $_GET['roomtype'] . '&furnish=' . $_GET['furnish'] }}"
