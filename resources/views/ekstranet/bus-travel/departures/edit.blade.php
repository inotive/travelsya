                ...
                <div class="card-body pt-0">
                    ...
                    <form action="{{ route('partner.bus.departures.update') }}" method="POST">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select name="from_route_id" class="form-select form-select-solid form-select-lg" required>
                                    <option value="">Pilih Kota Keberangkatan</option>
                                    @foreach($routes as $id => $name)
                                        <option value="{{ $id }}" {{ old('from_route_id', $departure->from_route_id) == $id ? 'selected' : '' }}>{{ $name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select name="to_route_id" class="form-select form-select-solid form-select-lg" required>
                                    <option value="">Pilih Kota Tujuan</option>
                                    @foreach($routes as $id => $name)
                                        <option value="{{ $id }}" {{ old('to_route_id', $departure->to_route_id) == $id ? 'selected' : '' }}>{{ $name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
