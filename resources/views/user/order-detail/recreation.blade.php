                                        ...
                                        <div class="card border border-1 text-center" style="background: #f4f4f4;">
                                            <div class="info-wrapper-grup" style="padding: 10px 16px 10px 16px;">
                                                <span class="text-gray-400 fs-8"
                                                    style="margin-bottom: 6px">Tanggal Booking</span><br>
                                                <span class="text fs-6 fw-bold"
                                                    style="margin-bottom: 6px">{{ \Carbon\Carbon::parse($transaction->book_date)->format('d M Y') }}</span><br>
                                                <span class="text fs-8"
                                                    style="margin-bottom: 6px">{{ \Carbon\Carbon::parse($transaction->book_date)->format('H:i') }}</span><br>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6 col-md-6">
                                        <div class="card border border-1 text-center" style="background: #f4f4f4;">
                                            <div class="info-wrapper-grup" style="padding: 10px 16px 10px 16px;">
                                                ...
                                                <span class="text fs-6 fw-bold"
                                                    style="margin-bottom: 6px">{{ \Carbon\Carbon::parse($transaction->expire_on)->format('d M Y') }}</span><br>
                                                <span class="text fs-8"
                                                    style="margin-bottom: 6px">{{ \Carbon\Carbon::parse($transaction->expire_on)->format('H:i') }}</span><br>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12 m-0">
                                        ...
                                        <div class="card border border-1 mt-5 mb-5">
                                            ...
                                            <div
                                                style="height: 250px; background: url('{{ asset($imagePath) }}') center/cover no-repeat; border-top-left-radius: 8px; border-top-right-radius: 8px;">
                                            </div>
                                            <div class="fw-bold fs-4 m-5">
                                                {{ $transaction->recreation->business_name }}
                                            </div>
                                        </div>
                                    </div>
                                    {{-- Kolom Kiri --}}
                                    <div class="col-12 mb-5">
                                        ...
                                        <div class="card border border-1 mb-5">
                                            ...
                                            <div class="m-5 d-flex align-items-center">
                                                ...
                                                <div class="symbol symbol-75px"
                                                    ...
                                                    <img src="{{ asset($imagePath) }}" alt="health-beauty-main">
                                                </div>
                                        ...
                                        <div class="card border border-1 mb-5">
                                            ...
                                            <div class="m-5">
                                                <div class="d-flex mb-1 justify-content-between">
                                                    ...
                                                    <div class="fs-8 fw-bold">{{ $transaction->customer_name }}</div>
                                                </div>
                                                <div class="d-flex mb-1 justify-content-between">
                                                    <div class="fs-8">Nomor Telepon</div>
                                                    <div class="fs-8 fw-bold">{{ $transaction->customer_handphone }}
                                                    </div>
                                                </div>
                                                <div class="d-flex mb-1 justify-content-between">
                                                    <div class="fs-8">Alamat Email</div>
                                                    <div class="fs-8 fw-bold">{{ $transaction->customer_email }}</div>
                                                </div>
                                                <div class="d-flex mb-1 justify-content-between">
                                                    <div class="fs-8">Kewarganegaraan</div>
                                                    <div class="fs-8 fw-bold">{{ $transaction->customer_country }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        {{-- Lokasi Hostel --}}
                                        <div class="card border border-1 mb-5">
                                            ...
                                            <div class="d-flex justify-content-between m-5">
                                                ...
                                                <a href="https://maps.google.com/?q={{ $transaction->recreation->lat }},{{ $transaction->recreation->lon }}"
                                            ...
                                            <div class="d-flex m-5">
                                                ...
                                                <div class="text-gray-400 fs-8">
                                                    {{ $transaction->recreation->address }}
                                                </div>
                                            </div>
                                        </div>
                                        @php
                                            ...
                                            $user = Auth::id();
                                            $rating_data = $transaction->transaction->commentRecreation;
                                        ...
                                        <div class="card border border-1 mb-5">
                                            ...
                                            <div class="m-5">
                                                ...
                                                <div class="d-flex mb-1 justify-content-between">
                                                    ...
                                                    <div class="fs-8 fw-bold">
                                                        {{ number_format($transaction->fee_admin + $transaction->kode_unik, 0, ',', '.') }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered mw-550px">
            ...
            <div class="modal-content">
                <div class="modal-header text-center">
                    <div class="fs-4 fw-bold m-3">{{ $transaction->recreation->business_name }} -
                        {{ $transaction->package->name }}
                    </div>
                    <!--begin::Close-->
                ...
                <form action="{{ route('profile.order-detail.recreation.rating') }}" method="POST">
                    @csrf
                    <input type="hidden" name="package_id" value="{{ $transaction->recreation_package_id }}" />
                    <input type="hidden" name="transaction_id" value="{{ $transaction->transaction_id }}" />
                    <input type="hidden" name="recreation_id" value="{{ $transaction->recreation->id }}" />
                    <div class="modal-body text-center">
                        <div>
                            <div class="fs-4 fw-bold m-3 mb-5">Berikan Nilai Pada
                                {{ $transaction->recreation->recreation_name }}
                            </div>
                        </div>
