                ...
                <table class="table-row-dashed fs-6 gy-5 table-bordered table align-middle"
                    ...
                    <thead>
                        <tr class="fw-bold fs-6 text-gray-800 ">
                            ...
                            <th class="text-center">Mitra // Gambar</th>
                    ...
                    <tbody>
                      @foreach ($clinics as $clinic)
                          <tr>
                              ...
                              <td class="text-center">{{ $clinic->clinic_id }}</td>

                              <td class="text-center">{{ $clinic->categories_services_id }}</td>

                              <td class="text-center">{{ $clinic->duration }}</td>

                              <td class="text-center">{{ $clinic->price }}</td>
                              
                              <td class="text-center">{{ $clinic->description }}</td>
