                ...
                <form id="kt_modal_new_target_form" action="{{ route('partner.management.hostel.setting.room.post') }}"
                    ...
                    <div class="row gy-5">
                        ...
                        <div class="col-6">
                            ...
                            <div class="btn-group w-100" data-kt-buttons="true"
                                ...
                                <label class="btn btn-outline btn-color-muted btn-active-success active"
                                    data-kt-button="true">
                                    <!--begin::Input-->
                                    <input class="btn-check" type="radio" name="method" value="ya"
                                ...
                                <label class="btn btn-outline btn-color-muted btn-active-success"
                                    ...
                                    <!--begin::Input-->
                                    <input class="btn-check" type="radio" name="method" checked="checked" value="tidak"
                        ...
                        <div class="col-4 extrabedWidget">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="extrabedsellingprice" id="extrabedsellingprice"
                                    class="form-control" placeholder="Masukan Biaya Extra Bed" readonly>
                            </div>
                        </div>
                        <div class="col-12">
                            <!--begin::Alert-->
                        ...
                        <div class="row-6">
                            ...
                            <!--begin::Image input-->
                            @for ($i = 0; $i < 5; $i++) <div class="image-input image-input-outline m-5"
