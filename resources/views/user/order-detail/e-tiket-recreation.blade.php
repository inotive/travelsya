            ...
            <div class="row m-10 m-sm-5">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-5"
                            ...
                            <div class="offset-lg-3 col-9">
                                <div class="fw-bold fs-1" style="color: white">Recreation e-Booking</div>
                        ...
                        <div class="col-12 offset-lg-1 col-lg-6">
                            <div class="fs-2 fw-bold mt-5">{{ $data->recreation->name ?? '' }}</div>
                            <div class="fs-6 mt-5">{{ $data->recreation->address ?? '' }}
                            </div>
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-lg-6  mt-5">
                                    ...
                                    <div class="fs-6" style="color: #c02425">
                                        {{ \Carbon\Carbon::parse($data->transaction->created_at)->translatedFormat('d F Y') }}
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-lg-6 mt-5">
                                    ...
                                    <div class="fs-6" style="color: #c02425">
                                        {{ \Carbon\Carbon::parse($data->expire_on)->translatedFormat('d F Y') }}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 mb-10">
                    ...
                    <div class="card border border-1 mb-5">
                        ...
                        <div class="m-5">
                            ...
                            <div class="d-flex mb-1 justify-content-between">
                                ...
                                <div class=" fw-bold">{{ $data->package->name ?? 'Paket tidak ditemukan' }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card border border-1 mb-5">
                        ...
                        <div class="m-5">
                            <div class="d-flex mb-1 justify-content-between">
                                <div class="">Nama Pemesan</div>
                                <div class=" fw-bold">{{ $data->transaction->user->name ?? '-' }}</div>
                            </div>
                            <div class="d-flex mb-1 justify-content-between">
                                <div class="">Nomor Telepon</div>
                                <div class=" fw-bold">{{ $data->transaction->user->phone ?? '-' }}</div>
                            </div>
                            <div class="d-flex mb-1 justify-content-between">
                ...
                <div class="col-12 mb-10">
                    <div class="catatan-penting">
                        ...
                        <ul style="list-style-type:disc">
                            <li>Tiket ini berlaku untuk satu kali masuk sesuai tanggal yang tertera.</li>
                            <li>Harap tunjukkan e-tiket ini beserta identitas diri yang sah saat masuk.</li>
                            <li>Tiket yang sudah dibeli tidak dapat dikembalikan atau ditukar.</li>
                            <li>Pihak penyelenggara berhak menolak masuk jika e-tiket tidak valid atau ada pelanggaran aturan.</li>
