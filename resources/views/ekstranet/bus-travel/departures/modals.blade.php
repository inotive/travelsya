        ...
        <div class="modal-content">
            ...
            <form action="{{ route('partner.bus.departures.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    @endif
                    <input type="hidden" name="bus_travel_has_bus_id" value="{{ $defaultBusId }}">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="departure_date" class="form-label required">Tanggal Keberangkatan</label>
                            <input type="date" class="form-control" name="departure_date" id="departure_date" value="{{ old('departure_date') }}" required>
                        </div>
                        <div class="col-md-6">
                            <label for="departure_time" class="form-label required">Waktu Keberangkatan</label>
                            <input type="time" class="form-control" name="departure_time" id="departure_time" value="{{ old('departure_time') }}" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="from_city_id" id="from_city_id" required>
                                ...
                                @foreach ($cities as $id => $city_name)
                                    <option value="{{ $id }}" {{ old('from_city_id') == $id ? 'selected' : '' }}>{{ $city_name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="to_city_id" id="to_city_id" required>
                                ...
                                @foreach ($cities as $id => $city_name)
                                    <option value="{{ $id }}" {{ old('to_city_id') == $id ? 'selected' : '' }}>{{ $city_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="titik_naik" id="titik_naik" value="{{ old('titik_naik') }}" required>
                        </div>
                        <div class="col-md-6">
                            <label for="titik_turun" class="form-label required">Titik Turun</label>
                            <input type="text" class="form-control" name="titik_turun" id="titik_turun" value="{{ old('titik_turun') }}" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="duration" class="form-label required">Durasi (Jam)</label>
                            <input type="number" class="form-control" name="duration" id="duration" min="1" value="{{ old('duration') }}" required>
                        </div>
                        <div class="col-md-6">
                            <label for="price" class="form-label required">Harga (Rp)</label>
                            <input type="number" class="form-control" name="price" id="price" min="1000" value="{{ old('price') }}" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="form-check form-check-custom form-check-solid me-5 mb-2">
                                    <input class="form-check-input" type="checkbox" name="days[]" value="0" id="day0" {{ is_array(old('days')) && in_array('0', old('days')) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="day0">Minggu</label>
                                </div>
                                <div class="form-check form-check-custom form-check-solid me-5 mb-2">
                                    <input class="form-check-input" type="checkbox" name="days[]" value="1" id="day1" {{ is_array(old('days')) && in_array('1', old('days')) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="day1">Senin</label>
                                </div>
                                <div class="form-check form-check-custom form-check-solid me-5 mb-2">
                                    <input class="form-check-input" type="checkbox" name="days[]" value="2" id="day2" {{ is_array(old('days')) && in_array('2', old('days')) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="day2">Selasa</label>
                                </div>
                                <div class="form-check form-check-custom form-check-solid me-5 mb-2">
                                    <input class="form-check-input" type="checkbox" name="days[]" value="3" id="day3" {{ is_array(old('days')) && in_array('3', old('days')) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="day3">Rabu</label>
                                </div>
                                <div class="form-check form-check-custom form-check-solid me-5 mb-2">
                                    <input class="form-check-input" type="checkbox" name="days[]" value="4" id="day4" {{ is_array(old('days')) && in_array('4', old('days')) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="day4">Kamis</label>
                                </div>
                                <div class="form-check form-check-custom form-check-solid me-5 mb-2">
                                    <input class="form-check-input" type="checkbox" name="days[]" value="5" id="day5" {{ is_array(old('days')) && in_array('5', old('days')) ? 'checked' : '' }}>
                                    <label class="form-check-label" for="day5">Jumat</label>
                                </div>
                                <div class="form-check form-check-custom form-check-solid me-5 mb-2">
                                    <input class="form-check-input" type="checkbox" name="days[]" value="6" id="day6" {{ is_array(old('days')) && in_array('6', old('days')) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="bus_travel_has_bus_id" id="bus_travel_has_bus_id" required>
                            ...
                            @foreach ($allBuses as $id => $name)
                                <option value="{{ $id }}" {{ $id == $defaultBusId ? 'selected' : '' }}>{{ $city_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="row mb-3">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{ route('partner.bus.departures.delete') }}" method="POST">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="submit" class="btn btn-danger">Hapus</n                    </button>
                </div>
            </form>
        </div>
    </div>
