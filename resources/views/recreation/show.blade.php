              ...
              <div class="row mb-2">
                ...
                <div class="col">
                  ...
                  @endguest --}}
                      ...
                      <a
                      href="{{ route("recreations.reservasi") }}"
                      class="btn btn-danger px-4">Pesan Paket</a>
                  </div>
                  </div>
                  </div>
