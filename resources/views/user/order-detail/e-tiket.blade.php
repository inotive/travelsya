                ...
                <div class="row">
                    ...
                    <div class="col-12 offset-lg-1 col-lg-6">
                        <div class="bintang mt-5">
                            @for ($i = 0; $i < $data->hotel->star; $i++)
                                <span class="fa fa-star fs-1" style="color: orange;"></span>
                            @endfor

                        </div>
                        <div class="fs-2 fw-bold ">{{ $data->hotel->name }}</div>
                        <div class="fs-6 mt-5">{{ $data->hotel->address }}
                        </div>
                        <div class="row">
                ...
                <div class="card border border-1 mb-5">
                    ...
                    <div class="m-5">
                        <div class="d-flex mb-1 justify-content-between">
                            ...
                            <div class=" fw-bold">{{ $data->hotelRoom->name }}</div>
                        </div>
                        <div class="d-flex mb-1 justify-content-between">
                        ...
                        <div class="d-flex mb-1 justify-content-between">
                            ...
                            <div class=" fw-bold">{{ $data->hotelRoom->roomsize }}</div>
                        </div>
                        <div class="d-flex mb-1 justify-content-between">
