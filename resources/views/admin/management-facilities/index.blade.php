@extends('admin.layout', ['title' => 'Daftar Facilities', 'url' => ''])
        ...
        <div class="card-header pt-5">
            <div class="card-toolbar">
                <a class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#create">
                    <i class="ki-duotone ki-plus fs-2"></i>Tambah Fasilitas</a>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
            ...
            <div class="table-responsive">
                ...
                <table class="table-row-dashed fs-6 gy-5 table-bordered table align-middle"
                    ...
                    <tbody>
                        @foreach ($facilities as $facility)
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="{{ asset('storage/'.$facility->icon) }}" class="rounded" style="width: 75px">
                                </td>
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3 text-danger" data-bs-toggle="modal"
                                                ...
                                                data-bs-target="#kt_modal_delete_customer{{ $facility->id }}">
                                                Delete
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
                            ...
                            <div class="modal fade" id="kt_modal_delete_customer{{ $facility->id }}" tabindex="-1"
                                aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        <form action="{{ route('admin.facility.destroy', $facility->id) }}" method="POST"
                                            ...
                                            <div class="modal-header">
                                                <h2 class="fw-bold">DELETE FASILITAS</h2>
                                            ...
                                            <div class="modal-body py-10 px-lg-17">
                                                <p>Anda yakin ingin menghapus data Fasilitas dengan nama {{ $facility->name }}?
                                                </p>
                                            </div>
                        ...
                        @endforeach
                        @include('admin.management-facilities.edit')
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_target_form" class="form" method="post" enctype="multipart/form-data"
                        action="{{ route('admin.facility.store') }}">
                        @csrf
                        <input type="hidden" name="id" id="id">
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Create Facilites</h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Heading-->
                        <!--begin::Input group-->
                        <div class="row g-9 mb-8">
                            ...
                            <div class="col-md-12">
                                ...
                                <input class="form-control form-control-lg" id="name"
                                    placeholder="Masukan nama fasilitas" name="name" required />
