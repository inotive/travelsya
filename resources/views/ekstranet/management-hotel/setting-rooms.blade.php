        ...
        <div class="card-header pt-5">
            <div class="card-toolbar">
                <a class="btn btn-sm btn-light-primary"
                    href="{{ route('partner.management.hotel.setting.room.create', ['id' => $hotel->id]) }}">
                        ...
                        @foreach ($hotel->hotelRoom as $room)
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ ($room->totalroom ?? 0) - $roomCount }} Kamar</td>
                                <td class="text-center">{{ $roomCount }} Kamar</td>
                                ...
                                <td class="text-center">
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="{{ route('partner.management.room.detailroomhotel', $room->id) }}"
