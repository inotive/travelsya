    ...
    <div class="row gy-5 g-xl-10">
                ...
                <div class="card-body my-3">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="roomName" class="form-control" placeholder="Masukan Nama Hotel">
                        </div>
                        <div class="col-6">
                            <label class="form-label">Room Price</label>
                            <input type="text" name="roomPrice" class="form-control" placeholder="Masukan Nama Hotel">
                        </div>
                        <div class="col-6">
                            <label class="form-label">Room Selling Price</label>
                            <input type="text" name="roomSellingPrice" id="roomSellingPrice" class="form-control"
                        ...
                        <div class="col-6 d-flex justify-content-around">
                            <div class="form-check me-3">
                                <input class="form-check-input" type="checkbox" name="breakfastIncluded" id="flexCheckDefault"/>
                                <label class="form-check-label" for="flexCheckDefault">
                                    Breakfast Included
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="wifiIncluded" id="flexCheckDefault"/>
                                <label class="form-check-label" for="flexCheckDefault">
                                    Wifi Included
                                </label>
                            </div>
        ...
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    @for($i = 0; $i < 15; $i++)
                        <div class="d-flex mb-7 bg-light-info p-5 rounded">
                            <!--begin::Section-->
