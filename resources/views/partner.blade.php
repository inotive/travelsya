...
<div class="px-20">
  <div class="card" style="background:linear-gradient(to right, rgba(28, 50, 94, 0.9), rgba(245, 246, 252, 0)), url('https://images.unsplash.com/photo-1540541338287-41700207dee6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80') no-repeat center">
    <div class="card-body d-flex ps-xl-15">
      <div class="m-0">
        ...
        <div class="mb-3">
          ...
          <a href="/hotels" class="btn btn-color-white bg-body bg-opacity-15 bg-hover-opacity-25 fw-bold">Jelajah Hotel</a>
        </div>
      </div>
    </div>
  </div>
