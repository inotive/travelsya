                    ...
                    <tbody>
                        @foreach ($recreations as $recreation)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ($recreation->recreation_status)
                            ...
                            <div class="modal fade" id="kt_modal_delete_customer{{ $recreation->recreation_id }}"
                                tabindex="-1" aria-hidden="true">
                                <!-- Konten modal penghapusan -->
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    <div class="modal-content">
                                        <form action="{{ route('admin.rekreasi.destroy', $recreation->recreation_id) }}"
                                ...
                                <select name="category_recreation_id"
                                    ...
                                    @foreach ($category as $item)
                                        <option value="{{ $item->id }}"
                                            {{ old('category_recreation_id') == $item->id ? 'selected' : '' }}>
                                            {{ $item->name }}</option>
                                    @endforeach
                                </select>
