                            ...
                            <div class="col-md-12">
                                <ul class="nav nav-pills nav-pills-custom mb-3 main-menu">
                                    ...
                                    <li class="nav-item mb-3 me-3 me-lg-6 ">
                                        <!--begin::Link-->
                                        <a class="nav-link d-flex justify-content-between flex-column active flex-center overflow-hidden py-3"
                                    ...
                                    <li class="nav-item mb-3 me-3 me-lg-6 li-main-menu">
                                        <!--begin::Link-->
                                        <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden py-3"
                                            data-bs-toggle="pill" href="#aktif">
                                            <!--begin::Icon-->
                                            <div class="nav-icon">
                                            </div>
                                            <!--end::Icon-->
                                    ...
                                    <li class="nav-item mb-3 me-3 me-lg-6 li-main-menu">
                                        <!--begin::Link-->
                                        <a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden py-3"
                                            data-bs-toggle="pill" href="#riwayat">
                                            <!--begin::Icon-->
                                            <div class="nav-icon">
                                            </div>
                                            <!--end::Icon-->
                                                ...
                                                <div class="card-body py-5">
                                                    <div class="d-flex align-items-start mb-3">
                                                        <div class="p-3 bg-secondary rounded-circle bg-opacity-20 me-5">
                                                            <img alt=""
                                                                src="{{ asset('assets/media/products-categories/icon-' . $transaction['service'] . '.png') }}"
                                                                class="w-35px" />
                                                        </div>
                                                        <div class="">

                                                            <h3 class="fw-bold mb-3">
                                                                {{ $transaction['service'] != 'hostel' ? $transaction['detail_transaction'][0]['product']['description'] : 'hostel' }}
                                                            </h3>
                                                            <p class="text-gray-500">
                                                                {{ $transaction['service'] != 'hostel' ? $transaction['detail_transaction'][0]['no_hp'] : 'hostel' }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card card-bordered mb-3">
                                            <div class="card-body py-5">
                                                <div class="d-flex align-items-start mb-3">
                                                    <div class="p-3 bg-secondary rounded-circle bg-opacity-20 me-5">
                                                        <img alt=""
                                                            src="{{ asset('assets/media/products-categories/icon-plan.png') }}"
                                                            class="w-35px" />
                                                    </div>
                                                    <div class="">
                                            ...
                                            <div class="card-body py-5">
                                                <div class="d-flex align-items-start mb-3">
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <p class="text-gray-500">1x Kamar Deluxe Double atau Ranjang Lain -
                                                            Pemandangan Kota</p>
                                        ...
                                        @foreach ($transactionActive as $transaction)
                                            <div class="card card-bordered mb-3">
                                                ...
                                                <div class="card-footer py-5 d-flex justify-content-between">
                                                    ...
                                                    @endif
                                                    <a
                                                        href="{{ route('user.transaction.detail', $transaction['no_inv']) }}">
                                                        <i class="fa fa-chevron-right fa-lg text-dark"></i>
                                                    </a>
                                                </div>
                                            </div>
