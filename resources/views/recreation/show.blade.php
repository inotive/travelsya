                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between">
                                            <h1 class="fw-bold">Calm Spa & Leisure Place</h1>
                                            <div class="badge badge-primary">Balikpapan</div>
                                        </div>
                                        <p style="font-size: 13px">Komplek Balikpapan Super Blok, Ruko Blok C No. 19-25,
                                            Jl. Jendral Sudirman, Damai, Kec. Balikpapan Kota, Kota Balikpapan,
                                            Kalimantan Timur 76114</p>

                                        <div id="bintang" class="mb-1">
                                            @for ($i = 1; $i <= 5; $i++) <span class="card-text fa fa-star"
                                        ...
                                        <p>{{ "Calm Spa dan Leisure adalah tempat yang sempurna untuk relaksasi dan
                                            pemulihan diri. Dengan layanan pijat profesional, aromaterapi, dan fasilitas
                                            sauna, Anda akan merasakan ketenangan maksimal. Nikmati suasana yang damai,
                                            perawatan tubuh menyeluruh, dan lingkungan yang indah untuk menyegarkan
                                            pikiran dan tubuh Anda." ?? '' }}</p>
                                    </div>
                                </div>
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <div class="col ms-3">
                                <div class="fw-bold fs-5">
                                    @if ($avg_rate >= 1 && $avg_rate < 2) Sangat Kurang @elseif ($avg_rate>= 2 &&
                                        $avg_rate < 3) Kurang @elseif ($avg_rate>= 3 && $avg_rate < 4) Cukup
                                                @elseif($avg_rate>= 4 && $avg_rate < 5) Baik @elseif ($avg_rate==5)
                                                    Sangat Baik @else Nilai tidak valid @endif </div>
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        ...
                                                        <div class="col ms-5">
                                                            ...
                                                            <div class="fs-6 fw-light-grey-500">
                                                                {{
                                                                \Carbon\Carbon::parse($ratingItem->created)->diffForHumans()
                                                                ?? 0 }}
                                                            </div>
            ...
            <div class="row w-75 me-auto ms-auto mt-5">
                <div class="col-6">
                    <div class="card card-hostel mb-3">
                        <div class="row mb-2">
                            <div class="col-5">
                                <a class="d-block overlay p-2" data-fslightbox="lightbox-basic-1"
                                    href="https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D">
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-150px "
                                        style="background-image:url('https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')">
                                    </div>
                            ...
                            <div class="col">
                                <div class="row mt-5 px-2">
                                    <h4 class="card-title text-gray-900">Paket Spa 1</h4>
                        ...
                        <div class="card-footer d-flex justify-content-between">
                            <p class="fw-semibold d-block fs-2 text-danger">Rp.
                                {{ number_format(140000, 0, ',', '.') }}</p>
                            {{-- @guest
                            <a href="{{ route('login') }}" class="btn btn-danger px-4 py-2">Login Dulu</a>
                            @endguest --}}

                            <a href="{{ route('recreations.reservasi') }}" class="btn btn-danger px-4">Pesan Paket</a>
                        </div>
                    </div>
                </div>
