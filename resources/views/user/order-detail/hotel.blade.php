                                ...
                                <div class="row">
                                    <div class="col-12 m-0">
                                        ...
                                        <div class="card border border-1 mt-5 mb-5">
                                            @if ($hotelPict)
                                                <div
                                                    style="height: 250px; background: url('{{ asset('media/hotel/' . $hotelPict->image) }}') center/cover no-repeat; border-top-left-radius: 8px; border-top-right-radius: 8px;">
                                                </div>
                                            @endif
                                                ...
                                                <div class="m-5 d-flex align-items-center">
                                                    @if ($roomPict)
                                                        <div class="symbol symbol-75px"
                                                            style="background:url('{{ asset('media/hotel/' . $roomPict->image) }}')">
                                                ...
                                                <div class="m-5">
                                                    <div class="d-flex mb-1 justify-content-between">
                                                        ...
                                                        @if ($transactionHotel->transaction->status === 'EXPIRED')
                                                            <div class="fs-8 fw-bold text-danger">
                                                                {{ $transactionHotel->transaction->status }}</div>
                                                    ...
                                                    <div class="d-flex mb-1 justify-content-between">
                                                        ...
                                                        <div class="fs-8 fw-bold">
                                                            {{ \Carbon\Carbon::parse($transactionHotel->reservation_start)->format('d M Y H:i') }}
                                                        </div>
                                                    </div>
                                                    <div class="d-flex mb-1 justify-content-between">
                                                        <div class="fs-8">Metode Pembayaran</div>
                                                        <div class="fs-8 fw-bold">
                                                            {{ str_replace('_', ' ', $transactionHotel->transaction->payment_method) }}
                                                        </div>
                                                    </div>
                                                    <div class="d-flex mb-1 justify-content-between">
                                                        <div class="fs-8">Biaya Hotel</div>
                                                        <div class="fs-8 fw-bold">
                                                            {{ number_format($transactionHotel->hotelRoom->sellingprice, 0, ',', '.') }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card border border-1">
                                                <div class="text-center" style="margin-top: 24px; margin-bottom: 24px;">
                                                    <div class="pembungkus mx-sm-10" style="margin-bottom: 24px;">
                                                        <img src="{{ asset('assets/media/svg/profile-account/order-history/frame-1.svg') }}"
                                                            style="width: 48px; height:48px; margin-bottom: 8px;" />
                                                        <div class="text fs-8">E-tiket</div>
                                                    </div>
                                                    <div class="pembungkus mx-sm-10" style="margin-bottom: 24px;">
                                                        <img src="{{ asset('assets/media/svg/profile-account/order-history/frame-2.svg') }}"
                                                            style="width: 48px; height:48px; margin-bottom: 8px;" />
                                                        <div class="text fs-8">Bukti Pembayaran</div>
                                                    </div>
                                                    <div class="pembungkus mx-sm-10">
                                                        <img src="{{ asset('assets/media/svg/profile-account/order-history/frame-3.svg') }}"
                                                            style="width: 48px; height:48px; margin-bottom: 8px;" />
