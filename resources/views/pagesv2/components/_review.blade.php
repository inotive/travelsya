            ...
            <div class="carousel-item">
                <div class="card-wrapper container-md d-flex justify-content-around gap-2">
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <div class="d-flex flex-row align-items-center mb-3">
                                <div class="card-title d-flex align-items-center fs-2">{{ $r['rate'] }}/<small
                                        class="opacity-75">5</small>
                                </div>
                                <span class="opacity-75 ms-sm-auto">{{
                                    \App\Helpers\General::getDateShortMonth($r['created_at']) }}</span>
                            </div>
                            <div class="card-subtitle fs-5 opacity-75 fw-bold mb-1 text-capitalize">{{ $r['user']['name'] ?? 'Invalid User' }}</div>
