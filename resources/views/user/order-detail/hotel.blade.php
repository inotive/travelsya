                                ...
                                <div class="row">
                                    <div class="col-12 m-0">
                                        ...
                                        <div class="card border border-1 mt-5 mb-5">
                                            <div
                                                style="height: 250px; background: url('{{ asset('media/hotel/'.$hotelPict->image) }}') center/cover no-repeat; border-top-left-radius: 8px; border-top-right-radius: 8px;"></div>
                                        ...
                                        <div class="card border border-1 mb-5">
                                            ...
                                            <div class="m-5 d-flex align-items-center">
                                                <div class="symbol symbol-75px"
                                                     style="background:url('{{ asset('storage/'.$roomPict->image) }}')">
                                                    <img src="{{ asset('storage/' . $roomPict->image) }}"
                                                         alt="hotel-main">
                                                </div>
