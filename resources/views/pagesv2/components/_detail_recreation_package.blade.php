<div class="px-3 mb-35px fs-2" id="paket">
    <div class="section-title mb-4">
        ...
        <div class="w-100 title text-capitalize d-flex flex-row align-items-center">
            ...
            <button type="button" class="btn btn-outline-secondary border rounded-pill ms-2">1 Dec</button>
            <button type="button" class="btn btn-outline-secondary border rounded-pill ms-2">2 Dec</button>
            <button type="button" class="btn btn-outline-secondary border rounded-pill ms-2">3 Dec</button>
            <button type="button"
    ...
    <div class="row">
        <div class="col-8">
            <div class="card bg-danger bg-opacity-25 p-3 mb-35px">
                <span class="title fw-bold mb-3">Tiket Reguler</span>
                                ...
                                <div class="accordion-header w-100">
                                    <div class="w-100" id="paket-1">
                                        <button class="accordion-button collapsed bg-opacity-0 " type="button"
                                            data-bs-toggle="collapse" data-bs-target="#paket-collapse-1"
                                            aria-expanded="true" aria-controls="paket-collapse-1">
                                            <div class="d-flex flex-column">
                                                <h2 class="mb-25px">Tiket Reguler Weekday</h2>
                                                <div class="d-flex flex-column mb-25px">
                                                    <div class="d-flex flex-row align-items-center mb-25px fs-3">
                                                        ...
                                                        <span class="ms-3">Bisa 100% refund dengan auransi (Asuransi
                            ...
                            <div class="card-body accordion-collapse collapse" id="paket-collapse-2"
                                ...
                                <div
                                    ...
                                    <card class="border rounded-2 d-flex flex-column align-items-center p-3">
                                        ...
                                        <span class="fs-3">{{ date('d M', strtotime($day))
                                            }}</span>
                                    </card>
                                    @endforeach
                                </div>
            ...
            <div class="card bg-danger bg-opacity-25 p-3">
                <span class="title fw-bold mb-3">Tiket Premium</span>
                <form action="{{ route($route, ['clinic' => 1]) }}" method="post">
                    @csrf
                    <div class="accordion" id="list_paket">
                        <div class="card accordion-item mb-3">
                            ...
                            <div class="card-body accordion-collapse collapse" id="paket-collapse-1"
                                aria-labelledby="paket-1">
                                <div
                                    class="d-flex flex-row p-1 rounded-1 align-items-center mb-3 justify-content-between gap-1">
                                    @php
                        ...
                        <div class="card accordion-item mb-3">
                            ...
                            <div class="w-100 bg-dark bg-opacity-25 text-light position-relative fs-5 p-3 fixed-bottom card-img-bottom-rounded"
                                role="alert">
                                Tidak tersedia di tanggal yang dipilih
                            </div>
                        </div>
