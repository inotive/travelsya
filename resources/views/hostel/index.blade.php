                            ...
                            @endforeach --}}
                                ...
                                @foreach ($facilities as $facility)
                                    <div class="col-12">
                                        <div class="form-check">
                                            <input class="form-check-input" name="facility[]" type="checkbox"
                                                value="{{ $facility->id }}" id="flexCheckDefault"
                                    ...
                                    <div class="col-3">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <select name="property" id="property" class="form-select">
                                                ...
                                                <option value="apartemen"
                                                    {{ $params['property'] == 'apartemen' ? 'selected' : '' }}>
                                                    Apartemen</option>
                                                <option value="villa"
                                                    {{ $params['property'] == 'villa' ? 'selected' : '' }}>
                                                    Villa</option>
                                                <option value="residence"
                                                    {{ $params['property'] == 'residence' ? 'selected' : '' }}>
                                                    Residence</option>
                                                <option value="rumah"
                                                    {{ $params['property'] == 'rumah' ? 'selected' : '' }}>
                                                    Rumah</option>
                                            </select>
                                        </div>
                                        <div class="col-3">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <select name="furnish" id="furnish" class="form-select">
                                                <option value="" {{ $params['furnish'] == '' ? 'selected' : '' }}>
                                                    Semua
                                                </option>
                                                <option value="fullfurnished"
                                                    {{ $params['furnish'] == 'fullfurnished' ? 'selected' : '' }}>
                                                    Full Furnished</option>
...
<div class="col-4">
     ...
     @endforeach
                    ...
                    <a
                    href="{{ route('hostel.room', $hostel->id) . '?location=' . $_GET['location'] . '&start=' . $_GET['start'] . '&duration=' . $_GET['duration'] . '&property=' . $_GET['property'] . '&category=' . $_GET['category'] . '&roomtype=' . $_GET['roomtype'] . '&furnish=' . $_GET['furnish'] }}"
