                            ...
                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex flex-wrap fw-semibold fs-3 mb-1 pe-1">
                                            <a class="d-flex align-items-center text-gray-700 text-hover-primary me-5 mb-2">
                                                ...
                                                </i>{{ $hostelbookdates->transaction->name }}</a>
                                ...
                                <div class="d-flex flex-wrap flex-stack ">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 pe-12 ">
                                        ...
                                        <div class="d-flex flex-wrap ">
                                            <a href="#" class="text-gray-900 text-hover-primary fs-5 fw-bold me-1">25
                                                AGUS 20</a>
                                        </div>
                                        <!--end::Stats-->
                                    </div>
                                ...
                                <div class="d-flex flex-wrap flex-stack mt-5 ">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 pe-8 ">
                                        ...
                                        <div class="d-flex flex-wrap mt-1">
                                            <a href="#"
                                                class="text-gray-900 text-hover-primary fs-5 fw-bold me-1">Deluxe Room</a>
                                        </div>
                                        <!--end::Stats-->
                                    </div>
                                ...
                                <div class="d-flex flex-wrap flex-stack ">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 pe-12 ">
                                        ...
                                        <div class="d-flex flex-wrap mb-10">
                                            <!--begin::Stat-->
                                            <a href="#"
                                                class="text-gray-900 text-hover-primary fs-5 fw-bold me-1">Tersewa
                                            </a>
                                        </div>
