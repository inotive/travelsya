                ...
                <table class="table-row-dashed fs-6 gy-5 table-bordered table align-middle"
                    ...
                    <thead>
                        <tr class="fw-bold fs-6 text-gray-800 ">
                            ...
                            <th class="text-center">Nama Rekreasi</th>
                    ...
                    <tbody>
                      @foreach ($recreations as $recreation)
                                  ...
                                  <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                      ...
                                      <div class="menu-item px-3">
                                          <a href="" data-bs-toggle="modal" data-bs-target="#modal-edit"
                                              ...
                                              data-id="{{ $recreation->recreation_id }}">
                                              Edit
                                          </a>
                                      </div>
                                      <!--end::Menu item-->
                                      ...
                                      <div class="menu-item px-3">
                                          <a href="#" class="menu-link px-3 text-danger" data-bs-toggle="modal"
                                              ...
                                              data-bs-target="#kt_modal_delete_customer{{ $recreation->recreation_id }}">
                                              Delete
                                          </a>
                                      </div>
                                      <!--end::Menu item-->
                          ...
                          <div class="modal fade" id="kt_modal_delete_customer{{ $recreation->recreation_id }}" tabindex="-1"
                              aria-hidden="true">
                              <!-- Konten modal penghapusan -->
                              <div class="modal-dialog modal-dialog-centered mw-650px">
                                  <div class="modal-content">
                                      <form action="{{ route('admin.rekreasi.destroy', $recreation->recreation_id) }}" method="POST"
