            ...
            <div class="card rounded-4 border-1 shadow">
                <div class="card-body">
                    <div class="d-flex flex-row align-items-center mb-3">
                        ...
                        <input type="radio" name="sapa_pemesan" class="ms-5" id="radio_nyonya" value="nyonya" required>
                        <span class="ms-3">Nyonya</span>
                        <input type="radio" name="sapa_pemesan" class="ms-5" id="radio_nona" value="nona" required>
                        <span class="ms-3">Nona</span>
                    </div>
                    <div class="mb-3">
                        <label for="nama_pemesan" class="form-label">Nama</label>
                        <input type="text" name="nama_pemesan" class="form-control" value="{{ $user->name }}"
                            placeholder="Masukan nama">
                    </div>
                    <div class="mb-3">
                        <label for="nope_pemesan" class="form-label">Nomor Ponsel</label>
                        <input type="text" name="phone_pemesan" class="form-control" value="{{ $user->phone }}"
                            placeholder="Masukan nomor Handphone">
                    </div>
                    <div class="mb-3">
                        <label for="email_pemesan" class="form-label">Alamat Email</label>
                        <input type="email" name="email_pemesan" class="form-control" value="{{ $user->email }}"
            ...
            <div class="card rounded-4 border-1 shadow">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_pengunjung" placeholder="Masukan nama pengunjung">
                    </div>
                    <div class="mb-3">
                        <label for="nope_pengunjung" class="form-label">Nomor Ponsel</label>
                        <input type="text" class="form-control" id="nope_pengunjung" placeholder="Masukan nomor handphone">
                    </div>
                    <div class="mb-3">
                        <label for="email_pengunjung" class="form-label">Alamat Email</label>
                        <input type="email" class="form-control" id="email_pengunjung" placeholder="Masukan Email">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-35px">
            <div class="card rounded-4 border-1 shadow">
                ...
                <div class="card-body d-flex flex-row align-items-center">
                    ...
                    <span class="ms-3">Kamu akan mendapatkan {{ \App\Helpers\General::countPoint(($paket['price'] * $qty), $service_id) }} poin</span>
        ...
        <div class="card rounded-4 border-1 shadow fs-5 mb-35px">
            <div class="card-body p-5">
                <div class="d-flex flex-row align-items-center">
                    <img src="{{ asset('storage/'. (isset($paket->image) && isset($paket->image->image) ? $paket->image->image : 'images/not_found.jpg')) }}" onerror="this.src=`{{ asset('images/not_found.jpg') }}`" alt="" width="50" height="50" class="rounded-1">
                    <span class="fw-bold ms-3 text-wrap">{{ $paket['clinic']['clinic_name'] ?? 'Invalid clinic' }}</span>
                ...
                <div class="d-flex flex-column">
                    ...
                    <span>{{ \App\Helpers\General::getDateShortMonth(now()) }} - {{ \App\Helpers\General::getDateShortMonth(\Carbon\Carbon::now()->addDays($paket['expiry_date'])) }}</span>
                </div>
                <hr class="opacity-25 my-5">
                <div class="d-flex flex-column">
