        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    <!--begin::Image-->
                    <img class="theme-light-show mx-auto  mb-10 mb-lg-20" style="width : 75%; height: 75%;"
                        src="{{ asset('assets/media/bg-login.png') }}" alt="" />
                    ...
                    <img class="theme-dark-show mx-auto  mb-10 mb-lg-20"
                        src="{{ asset('assets/media/bg-login.png
                                                                                                                                                                                            ') }}"
                        alt="" />
                    <!--end::Image-->
