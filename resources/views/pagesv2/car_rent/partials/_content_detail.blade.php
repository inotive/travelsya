                        ...
                        <div class="position-relative">
                            <div class="card-img-container" style="overflow: hidden;">
                                <img id="main-car-image"
                                    src="{{ $car->image_url ? Storage::url($car->image_url) : 'https://thumb.ac-illust.com/b1/b170870007dfa419295d949814474ab2_t.jpeg' }}"
                                ...
                                @foreach ($car->images as $index => $image)
                                    <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                        <div style="display: flex; justify-content: center; align-items: center; height: 70vh;">
                                            <img src="{{ $image->url ? Storage::url($image->url) : (is_string($image) ? Storage::url($image) : 'https://thumb.ac-illust.com/b1/b170870007dfa419295d949814474ab2_t.jpeg') }}"
