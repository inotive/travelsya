            ...
            <div class="container">
                <div class="row m-10 m-sm-5">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex justify-content-around align-items-center">
                                        <img src="{{ asset('assets/media/illustrations/sigma-1/tsyaa.png') }}" style="max-width: 15%" alt="">
                                        <img src="{{asset('assets/media/logos/logo.png')}}" style="max-width: 25%" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 mb-10">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-5" style="background: rgb(192,36,37); background: linear-gradient(120deg, rgba(192,36,37,1) 60%, rgba(255,255,255,1) 60%);">
                                <div class="offset-lg-3 col-9">
                                    <div class="fw-bold fs-1" style="color: white">Hotel e-Booking</div>
                                    <div class="fs-3" style="color: white">Itenerary/Receipt</div>
                                </div>
                                <div class="col-12">
                                    <div class="offset-lg-3 col-9">
                                        <img class="img-fluid" src="{{ asset('assets/media/illustrations/sigma-1/nunjuk.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 offset-lg-1 col-lg-6">
                                ...
                                <div class="fs-2 fw-bold ">Hemra Hotel</div>
                    ...
                    <div class="col-12 mb-10">
                        <div class="catatan-penting">
                            ...
                            <ul style="list-style-type:disc">
                                <li>Sewaktu check-in diperlukan tanda pengenal dengan foto yang resmi dikeluarkan oleh pemerintah dan kartu kredit atau deposit tunai untuk
                                    menutup biaya tidak terduga pemenuhan permintaan khusus bergantung pada ketersediaan sewaktu check-in dan mungkin menimbulkan biaya
                        ...
                        <div class="card" style="border-radius: 150px;background: #c02425">
                            <div class="row m-5">
                                <div class="col-12 col-lg-4" style="color: white">
                                    ...
                                    <i class="fa-brands fa-whatsapp text-white fs-1" style="margin-right: 8px; color:white;"></i>
                                ...
                                <div class="col-12 col-lg-4" style="color: white">
                                    <div class="d-flex justify-content-center align-items-center">
                                    <i class="fa-solid fa-globe text-white fs-1" style="margin-right: 8px; color:white"></i>
