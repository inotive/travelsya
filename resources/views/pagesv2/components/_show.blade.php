<div class="section-header">
    <h2 class="text-gray" style="position: relative; top: 3px;">Menampilkan XXX hasil pencarian</h2>
    <div style="display: flex; align-items: center;">
        <h1 class="text-dark" style="position: relative; top: 3px;">{{ $section_title }}</h1>
    </div>
</div>
