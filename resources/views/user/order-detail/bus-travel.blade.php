                                ...
                                <div class="row">
                                    <div class="col-12 m-0">
                                        ...
                                        <div class="card border border-1 mt-5 mb-5">
                                            @php
                                                $hostelImage = $transaction->busTravel->image; // Pastikan $hostelPict tidak null
                                                $imagePath = $hostelImage ? asset('storage/'.$hostelImage) : 'https://images.unsplash.com/photo-1618805154647-7d89ac05926b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D';
                                            @endphp
                                    ...
                                    <div class="col-12 mb-5">
                                        ...
                                        <div class="card border border-1 mb-5">
                                            ...
                                            <div class="m-5 d-flex align-items-center">
                                                @php
                                                    $roomImage = $transaction->busTravel->image;
                                                    $imagePath = $roomImage ? 'storage/'. ($roomImage) : 'https://images.unsplash.com/photo-1618805154647-7d89ac05926b?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D';
                                                @endphp
                                                <div class="symbol symbol-75px"
                                                    style="background:url('{{ asset($imagePath) }}')">
                                                    <img src="{{ asset($imagePath) }}" alt="bus-travel-main">
                                                </div>
