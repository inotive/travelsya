                ...
                <div class="col p-3">
                    <a href="{{ route('rekreasi.detail', ['id' => $package['recreation_id'], 'date' => \Carbon\Carbon::now()->addDay()->format('Y-m-d')]) }}"
                        ...
                        <div class="card" style="box-shadow: 0 10px 15px gray">
                            <img src="{{ optional($package->image)->image ? Storage::url(Str::after($package->image->image, 'public/')) : 'https://images.unsplash.com/photo-1461988320302-91bde64fc8e4?ixid=2yJhcHBfaWQiOjEyMDd9&&fm=jpg&w=400&fit=max' }}"
