@extends('ekstranet.layout', ['title' => 'Profile', 'url' => '#'])
...
@section('content-admin')
    <div class="card">
        ...
        <form id="kt_modal_new_target_form" class="form" method="post"
            action="{{ route('partner.update-profile', $data->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row mb-6">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="image-input image-input-outline m-5" data-kt-image-input="true">
                            ...
                            <label
                                ...
                                title="Remove image"
                                onclick="document.querySelector('input[name=image_remove]').value = '1';">
                                <i class="ki-outline ki-cross fs-3"></i>
                            </label>
                            <!--end::Remove button-->
                        </div>
                ...
                <div class="row g-9 mb-8">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control form-control-lg" id="email" name="email" readonly
            ...
            <div class="card-footer text-end">
                <div class="d-flex justify-content-between">
                    <a href="{{ route('partner.dashboard') }}" class="btn btn-outline text-dark w-100 me-2">Kembali</a>
