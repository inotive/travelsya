                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    @php
                                        ...
                                        $image = $hotelImage !== null ? $hotelImage->image : null;
                                    @endphp

                                    <a class="d-block overlay" data-fslightbox="lightbox-basic"
                                        href="{{ asset($image ?: 'storage/assets/media/logos/logo-square.png') }}">

                                        <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-175px"
                                            style="background-image:url('{{ asset($image ?: 'storage/assets/media/logos/logo-square.png') }}')">
                                        </div>
...
<div class="col-4">
     ...
     @endforeach
                ...
                @auth
                    <a
                    href="{{ route('hotels.reservation', ['idroom' => $room->id]) }}?location={{ $request['location'] }}&start={{ $request['start'] }}&duration={{ $request['duration'] }}&room={{ $request['room'] }}&guest={{ $request['guest'] }}"
