@extends('ekstranet.layout', ['title' => 'Daftar Paket Rekreasi - Edit Paket Rekreasi', 'url' => '#'])
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-6 mb-4">
                                    <div class="card h-100">
                                        <img src="{{ Storage::url($mainImage->image_url) }}" class="card-img-top" style="height: 150px; object-fit: cover;" alt="Gambar Utama" onerror="this.src='{{ asset('images/not_found.jpg') }}';">
                        ...
                        <div class="row">
                            @if(count($additionalImages) > 0)
                                @foreach($additionalImages as $image)
                                    <div class="col-md-4 col-sm-6 mb-4">
                                        <div class="card h-100">
                                            <img src="{{ Storage::url($image->image_url) }}" class="card-img-top" style="height: 150px; object-fit: cover;" alt="Image" onerror="this.src='{{ asset('images/not_found.jpg') }}';">
                                            <div class="card-body text-center p-3">
