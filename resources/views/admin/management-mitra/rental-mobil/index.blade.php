                          ...
                          <div class="modal fade" id="kt_modal_delete_customer{{ $rental->car_rental_id }}" tabindex="-1"
                              ...
                              <div class="modal-dialog modal-dialog-centered mw-650px">
                                  <div class="modal-content">
                                      <form action="{{ route('admin.rental-mobil.destroy', $rental->car_rental_id) }}" method="POST"
                                          ...
                                          <div class="modal-body py-10 px-lg-17">
                                              <p>Anda yakin ingin menghapus data klinik dengan nama {{ $rental->business_name }}?
                                              </p>
                                          </div>
