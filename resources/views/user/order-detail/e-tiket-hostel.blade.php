                    ...
                    <div class="card border border-1 mb-5">
                        ...
                        <div class="m-5">
                            ...
                            <div class="d-flex mb-1 justify-content-between">
                                ...
                                @php
                                    $start_date = \Carbon\Carbon::parse($data->reservation_start);
                                    $end_date = \Carbon\Carbon::parse($data->reservation_end);
                                    $difference_in_days = $end_date->diffInDays($start_date);
                                @endphp
                                <div class=" fw-bold">{{ $difference_in_days }} Hari</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 mb-10">
                    <div class="catatan-penting">
                        ...
                        <ul style="list-style-type:disc">
                            ...
                            <li>Pemesanan kamar hostel tidak dapat dibatalkan & biaya pemesanan tidak dapat dikembalikan
                            </li>
