        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                <form id="updateForm" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" id="hostel_room_images_id" name="hostel_room_images_id">
                    <input type="hidden" id="hostel_room_id" name="hostel_room_id">
                    ...
                    <div class="mb-13 text-center">
                        <!--begin::Title-->
                        <h1 class="mb-3">Edit Room Hostel Image</h1>
                        <!--end::Title-->
                    </div>
                    <!--end::Heading-->
                    <!--begin::Input group-->
...
@push('add-script')
    <script>
        $('body').on('click', '#btn-edit-image', function() {
            ...
            // alert(hostel_room_images_id);
            $.ajax({
                url: `showimage/${hostel_room_images_id}`,
                type: "GET",
                cache: false,
                success: function(response) {
                    $('#hostel_room_images_id').val(response.data[0].id);
                    $('#hostel_room_id').val(response.data[0].hostel_room_id);
        ...
        $('#update').click(function(e) {
            ...
            // Define variables
            let hostel_room_images_id = $('#hostel_room_images_id').val();
            let hostel_room_id = $('#hostel_room_id').val();
            ...
            // Ajax request
            $.ajax({
                url: `updateimage/${hostel_room_images_id}/`,
                type: "POST",
                cache: false,
