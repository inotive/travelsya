                    ...
                    <div class="card rounded-4 border-1 shadow">
                        <div class="card-body">
                            <div class="d-flex flex-row align-items-center mb-3">
                                ...
                                <input type="radio" name="sapa_pengunjung" class="ms-5" id="radio_nyonya" value="nyonya" required>
                                <span class="ms-3">Nyonya</span>
                                <input type="radio" name="sapa_pengunjung" class="ms-5" id="radio_nona" value="nona" required>
                                <span class="ms-3">Nona</span>
                            </div>
                            <div class="mb-3">
                                <label for="nama_pengunjung" class="form-label">Nama Lengkap</label>
                                <input type="text" name="nama_pengunjung" class="form-control" value="{{ $user->name }}"
                                    placeholder="Masukan nama">
                            </div>
                            <div class="mb-3">
                                <label for="nope_pengunjung" class="form-label">Nomor Ponsel</label>
                                <input type="text" name="phone_pengunjung" class="form-control" value="{{ $user->phone }}"
                                    placeholder="Masukan nomor Handphone">
                            </div>
                            <div class="mb-3">
                                <label for="email_pengunjung" class="form-label">Alamat Email</label>
                                <input type="email" name="email_pengunjung" class="form-control" value="{{ $user->email }}"
                            ...
                            <div class="mb-3">
                                ...
                                <select name="kewarganegaraan_pengunjung" class="form-select" required>
                                    @foreach ($country as $co)
                                        <option value="{{ $co['name'] }}" {{ $co['name'] == 'Indonesia' ? 'selected' : '' }}>{{ $co['name'] }}</option>
                                    @endforeach
                                </select>
                            </div>
                ...
                <div class="mb-35px">
                    <div class="card rounded-4 border-1 shadow">
                        ...
                        <div class="card-body d-flex flex-row align-items-center">
                            ...
                            <span class="ms-3">Kamu akan mendapatkan {{ \App\Helpers\General::countPoint(($package['price'] * $qty), $service_id) }} poin</span>
                ...
                <div class="card rounded-4 border-1 shadow fs-5 mb-35px">
                    <div class="card-body p-5">
                        <div class="d-flex flex-row align-items-center">
                            <img src="{{ asset('storage/'. $package->image->image) }}" onerror="this.src=`{{ asset('images/not_found.jpg') }}`" alt="" width="50" height="50" class="rounded-1">
                            <span class="fw-bold ms-3 text-wrap">{{ $package['recreation']['business_name'] ?? 'Invalid package' }}</span>
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <span>{{ \App\Helpers\General::getDateShortMonth($book_date) }} - {{ \App\Helpers\General::getDateShortMonth(\Carbon\Carbon::parse($book_date)->addDays($package['expiry_date'])) }}</span>
                        </div>
                        <hr class="opacity-25 my-5">
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex flex-row">
                                ...
                                <span class="ms-3">Berlaku hingga {{ $package['expiry_date'] }} hari sejak dibeli</span>
                            </div>
                            <div class="d-flex flex-row">
                                <span class="fa-solid fs-3 mb-3 fa-clock"></span>
