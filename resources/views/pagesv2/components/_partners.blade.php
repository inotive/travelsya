...
<div id="partnersCarouselControls" class="carousel carousel-dark slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        @foreach ($chunked_partners as $key => $partners)
        <div class="carousel-item {{ $key == 0 ? 'active' : 0 }}">
            <div class="card-wrapper container-md d-flex justify-content-around gap-2">
                @foreach ($partners as $partner)
                <div class="card shadow-sm rounded-4">
                    <img src="{{ $partner->img != '' ? $partner->img :'https://images.unsplash.com/photo-1461988320302-91bde64fc8e4?ixid=2yJhcHBfaWQiOjEyMDd9&&fm=jpg' }}"
                    ...
                    <div class="card-body">
                        <div class="card-content">
                            ...
                            <h3 class="mt-3 text-dark">{{ $partner->name }}</h3>
