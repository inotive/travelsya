                ...
                <div class="d-flex flex-wrap flex-sm-nowrap p-3 m-5 mt-4">
                    <div class="me-5 mb-0">
                        <div class="symbol symbol-100px symbol-lg-200px symbol-fixed position-relative">
                            <img src="{{ asset('storage/media/hostel/'.$hostelbookdates->hostel->hostelImage->where('main', 1)->first()->image) }}"
                                alt="image" />
                                {{-- <img src="{{ optional('storage/'. $hostelbookdates->hostel->hostelImage->where('main', 1)->first())->image }}"
     alt="image" /> --}}
                        </div>
                    </div>
                    <div class="flex-grow-1">
