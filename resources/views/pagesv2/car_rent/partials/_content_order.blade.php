            ...
            <div class="col-8">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-35px">
                        <div class="card rounded-4 border-1 shadow">
                            <div class="card-body">
                                ...
                                <input type="hidden" name="total_ticket" value="{{ $duration }}">
                    ...
                    <div class="section-title" style="margin-bottom: 25px;">
                        ...
                        <div class="subtitle text-capitalize mt-2">Pastikan mengisi detail pengunjung dengan benar
                            untuk kelancaran
                            acara
                        </div>
                    </div>
                        ...
                        <div class="card rounded-4 border-1 shadow">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <h2 class="text-dark">Tiket {{ number_format($duration) }} pax</h2>
                                    </div>
