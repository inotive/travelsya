                                        ...
                                        <div class="card border border-1 text-center" style="background: #f4f4f4;">
                                            <div class="info-wrapper-grup" style="padding: 10px 16px 10px 16px;">
                                                ...
                                                <span class="text fs-6 fw-bold"
                                                    style="margin-bottom: 6px">{{ \Carbon\Carbon::parse($transaction->start)->format('d M Y') }}</span><br>
                                    ...
                                    <div class="col-12 m-0">
                                        ...
                                        <div class="card border border-1 mt-5 mb-5">
                                            ...
                                            <div class="fw-bold fs-4 m-5">
                                                {{ $transaction->carRental->business_name }}
                                            </div>
                                        </div>
                                    </div>
                                    {{-- Kolom Kiri --}}
                                    <div class="col-12 mb-5">
                                            ...
                                            <div class="m-5 d-flex align-items-center">
                                                ...
                                                <div class="text" style="margin-left: 16px">
                                                    <div class="fs-6 fw-bold mb-2">
                                                        {{ $transaction->car->brand->name }} - {{ $transaction->car->carModel->name }}
                                                    </div>
                                        ...
                                        <div class="card border border-1 mb-5">
                                            ...
                                            <div class="d-flex justify-content-between m-5">
                                                ...
                                                <a href="https://maps.google.com/?q={{ $transaction->carRental->lat }},{{ $transaction->carRental->lon }}"
                                        ...
                                        @php
                                            ...
                                            $user = Auth::id();
                                            $rating_data = $transaction->transaction->commentCarRent;
        ...
        <div class="modal-dialog modal-dialog-centered mw-550px">
            ...
            <div class="modal-content">
                <div class="modal-header text-center">
                    <div class="fs-4 fw-bold m-3">{{ $transaction->carRental->business_name }} -
                        {{ $transaction->car->brand->name }} {{ $transaction->car->carModel->name }}
                    </div>
                    <!--begin::Close-->
                ...
                <form action="{{ route('profile.order-detail.car-rent.rating') }}" method="POST">
                    ...
                    <input type="hidden" name="car_rental_id" value="{{ $transaction->carRental->id }}" />
                    <div class="modal-body text-center">
                        <div>
                            <div class="fs-4 fw-bold m-3 mb-5">Berikan Nilai Pada
                                {{ $transaction->car->brand->name }} -
                                {{ $transaction->car->carModel->name }} -
                                {{ $transaction->carRental->business_name }}
                            </div>
                        </div>
