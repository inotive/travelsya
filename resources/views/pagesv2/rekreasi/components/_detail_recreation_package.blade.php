...
<div class="px-3 mb-35px fs-2" id="paket">
    <div class="section-title mb-4">
        ...
        <div class="w-100 title text-capitalize d-flex flex-row align-items-center">
            ...
            @for ($i = 1; $i <= 3; $i++)
                <button type="button"
                    class="btn btn-outline-secondary border rounded-pill ms-2">{{ \App\Helpers\General::getDateShortDayMonth(date('Y-m-d h:i:s', strtotime('+' . $i . ' days', strtotime(now())))) }}</button>
            @endfor
            <button type="button"
                                        ...
                                        <div class="card-body d-flex flex-row align-items-center">
                                            ...
                                            <div class="d-flex flex-row align-items-center ms-sm-auto">
                                                ...
                                                <div class="ms-3 input-group w-auto">
                                                    ...
                                                    <input type="text"
                                                        class="bg-none ms-3 border-0 outline-none text-center"
                                                        name="qty" id="qty_{{ $package->id }}" min="1"
                                                        style="width: 32px;" value="1" readonly>
                                                    <button type="button"
