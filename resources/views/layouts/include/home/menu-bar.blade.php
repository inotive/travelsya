        ...
        <div class="card-body">
          <div class="row gy-3">
              <div
                  ...
                  data-bs-toggle="modal" data-bs-target="#modal-hotel"
              >
                  <div class="row">
              ...
              <div
                  class="item-menubar col-4 col-md-3 col-lg-2 align-items-center"
                  data-bs-toggle="modal" data-bs-target="#modal-hostel"
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-hostel.png')}}"
                                  style="filter: grayscale(0)"
                                  class="w-40px"
                              />
                          </div>
                      ...
                      <span
                          class="col-md-8 col-sm-12 fw-bold fs-6 item-label text-gray-600">Hostel</span>
                  </div>
              </div>
              <div
                  class="item-menubar col-4 col-md-3 col-lg-2 align-items-center"
                  data-bs-toggle="modal" data-bs-target="#modal-bpjs"
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-bpjs.png')}}"
                                  style="filter: grayscale(0)"
                                  class="w-40px"
                              />
                          </div>
                      ...
                      <span
                          class="col-md-8 col-sm-12 fw-bold fs-6 item-label text-gray-600">BPJS</span>
                  </div>
              </div>
              <div
                  class="item-menubar col-4 col-md-3 col-lg-2 align-items-center"
                  data-bs-toggle="modal" data-bs-target="#modal-pln"
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-pln.png')}}"
                                  style="filter: grayscale(0)"
                                  class="w-40px"
                              />
                          </div>
                      ...
                      <span
                          class="col-md-8 col-sm-12 fw-bold fs-6 item-label text-gray-600">PLN</span>
                  </div>
              </div>
              <div
                  class="item-menubar col-4 col-md-3 col-lg-2 align-items-center"
                  data-bs-toggle="modal" data-bs-target="#modal-pdam"
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-pdam.png')}}"
                                  style="filter: grayscale(0)"
                                  class="w-40px"
                              />
                          </div>
                      ...
                      <span
                          class="col-md-8 col-sm-12 fw-bold fs-6 item-label text-gray-600">PDAM</span>
                  </div>
              </div>
              <div
                  class="item-menubar col-4 col-md-3 col-lg-2 align-items-center"
                  data-bs-toggle="modal" data-bs-target="#modal-tvBerbayar"
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-tv.png')}}"
                                  style="filter: grayscale(0)"
                                  class="w-40px"
                              />
                          </div>
                      ...
                      <span
                          class="col-md-8 col-sm-12 fw-bold fs-6 item-label text-gray-600">TV Berbayar</span>
                  </div>
              </div>
              <div
                  class="item-menubar col-4 col-md-3 col-lg-2 align-items-center"
                  data-bs-toggle="modal" data-bs-target="#modal-pulsadata"
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-pulsa.png')}}"
                                  style="filter: grayscale(0)"
                                  class="w-40px"
                              />
                          </div>
                      ...
                      <span
                          class="col-md-8 col-sm-12 fw-bold fs-6 item-label text-gray-600">Pulsa & Data</span>
                  </div>
              </div>
              <div
                  class="item-menubar col-4 col-md-3 col-lg-2 align-items-center"
                  data-bs-toggle="modal" data-bs-target="#modal-ewallet"
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-wallet.png')}}"
                                  style="filter: grayscale(0)"
                                  class="w-40px"
                              />
                          </div>
                      ...
                      <span
                          class="col-md-8 col-sm-12 fw-bold fs-6 item-label text-gray-600">E-Wallet</span>
                  </div>
              </div>
              <div
                  class="item-menubar col-4 col-md-3 col-lg-2 align-items-center"
                  data-bs-toggle="modal" data-bs-target="#modal-pajak"
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-pajak.png')}}"
                                  style="filter: grayscale(0)"
                                  class="w-40px"
                              />
                          </div>
                      ...
                      <span
                          class="col-md-8 col-sm-12 fw-bold fs-6 item-label text-gray-600">Pajak</span>
                  </div>
              </div>
              <div
                  class="item-menubar col-4 col-md-3 col-lg-2 align-items-center"
              ...
              >
                  <div class="row">
                      ...
                      <span
                          class="col-md-8 col-sm-12 fw-bold fs-6 item-label text-gray-600 text-gray-300">Health & Beauty</span>
                  </div>
              </div>
              <div
                  class="item-menubar col-4 col-md-3 col-lg-2 align-items-center"
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-plane.png')}}"
              ...
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-bus.png')}}"
                                  style="filter: grayscale(1)"
                                  class="w-40px"
                              />
                          </div>
                      ...
                      <span
                          class="col-md-8 col-sm-12 fw-bold fs-6 item-label text-gray-600 text-gray-300">Bus & Travel</span>
                  </div>
              </div>
              <div
                  class="item-menubar col-4 col-md-3 col-lg-2 align-items-center"
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-kai.png')}}"
                                  style="filter: grayscale(1)"
                                  class="w-40px"
                              />
                          </div>
                      ...
                      <span
                          class="col-md-8 col-sm-12 fw-bold fs-6 item-label text-gray-600 text-gray-300">Kereta Api</span>
                  </div>
              </div>
              <div
                  class="item-menubar col-4 col-md-3 col-lg-2 align-items-center"
              ...
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-mobil.png')}}"
                                  style="filter: grayscale(0)"
                                  class="w-40px"
                              />
                          </div>
              ...
              >
                  <div class="row">
                      <div class="col-md-4 col-sm-12 justify-content-center">
                          <div class="child-item-menubar">
                              <img
                                  src="{{asset('assets/media/products-categories/icon-transfer.png')}}"
                                  style="filter: grayscale(1)"
                                  class="w-40px"
                              />
                          </div>
                      ...
                      <span
                          class="col-md-8 col-sm-12 fw-bold fs-6 item-label text-gray-600 text-gray-300">Transfer Bank</span>
                  </div>
              </div>
                        ...
                        <div class="m-0">
                            <div class="position-relative fs-2x z-index-2 fw-bold text-white mb-2">
                                ...
                                <div>
                                    ...
                                    <br/><span class="fs-3 text-gray-300 me-2">Tingkatkan Mobilitasmu Selama Liburan!</span>
                                </div>
                            </div>
                        </div>
                    </div>
