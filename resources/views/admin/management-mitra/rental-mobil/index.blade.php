@extends('admin.layout', ['title' => 'Daftar Rental Mobil', 'url' => ''])
        ...
        <div class="card-header pt-5">
            <div class="card-toolbar">
                <a class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#create">
                    <i class="ki-duotone ki-plus fs-2"></i>Tambah Rental Mobil</a>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
                        ...
                        @foreach ($car_rentals as $rental)
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="{{ $rental->image != null && $rental->image != '-' ? asset('storage/' . $rental->image) : 'https://static.vecteezy.com/system/resources/previews/000/627/584/non_2x/vector-hotel-icon-symbol-sign.jpg' }}"
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                        ...
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3 text-danger" data-bs-toggle="modal"
                                                ...
                                                data-bs-target="#kt_modal_delete_customer{{ $rental->car_rental_id }}">
                                                Delete
                                            </a>
                                        </div>
                                        <!--end::Menu item-->
                            ...
                            <div class="modal fade" id="kt_modal_delete_customer{{ $rental->car_rental_id }}" tabindex="-1"
                                aria-hidden="true">
                                <!-- Konten modal penghapusan -->
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    <div class="modal-content">
                                        <form action="{{ route('admin.rental-mobil.destroy', $rental->car_rental_id) }}"
