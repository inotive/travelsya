...
<div style="display: flex; gap: 10px; padding: 5px; border-radius: 10px; align-items: center; flex-direction:row;"
    class="mb-3">
    <button class="panah btn btn-outline-primardangery rounded-circle" data-bs-target="#categoriesCarouselControls"
        data-bs-slide="prev">
        <span class="chevron fa-solid fa-chevron-left"></span>
    </button>
    <button class="panah btn btn-outline-danger rounded-circle" data-bs-target="#categoriesCarouselControls"
        data-bs-slide="next">
