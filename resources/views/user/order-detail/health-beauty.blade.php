                                        ...
                                        <div class="card border border-1 text-center" style="background: #f4f4f4;">
                                            <div class="info-wrapper-grup" style="padding: 10px 16px 10px 16px;">
                                                ...
                                                <span class="text fs-6 fw-bold"
                                                    style="margin-bottom: 6px">{{ \Carbon\Carbon::parse($transaction->created_at)->format('d M Y') }}</span><br>
                                                <span class="text fs-8"
                                                    style="margin-bottom: 6px">{{ \Carbon\Carbon::parse($transaction->created_at)->format('H:i') }}</span><br>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12 m-0">
                                        ...
                                        <div class="card border border-1 mt-5 mb-5">
                                            @php
                                                $hostelImage = (isset($transaction->clinic->image) && isset($transaction->clinic->image->image)) ? $transaction->clinic->image->image : '';
                                            ...
                                            <div class="fw-bold fs-4 m-5">
                                                {{ $transaction->clinic->clinic_name }}
                                            </div>
                                        </div>
                                    </div>
                                    {{-- Kolom Kiri --}}
                                    <div class="col-12 mb-5">
                                        ...
                                        <div class="card border border-1 mb-5">
                                            ...
                                            <div class="d-flex justify-content-between m-5">
                                                ...
                                                <a href="https://maps.google.com/?q={{ $transaction->clinic->lat }},{{ $transaction->clinic->lon }}"
        ...
        <div class="modal-dialog modal-dialog-centered mw-550px">
            ...
            <div class="modal-content">
                <div class="modal-header text-center">
                    <div class="fs-4 fw-bold m-3">{{ $transaction->clinic->name }} -
                        {{ $transaction->package->name }}
                    </div>
                    <!--begin::Close-->
