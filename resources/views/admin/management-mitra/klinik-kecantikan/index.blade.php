                      ...
                      @foreach ($clinics as $clinic)
                          <tr>
                              ...
                              <td class="text-center">
                                <img src="{{ $clinic->image != null ? asset('storage/' . $clinic->image) : 'https://static.vecteezy.com/system/resources/previews/000/627/584/non_2x/vector-hotel-icon-symbol-sign.jpg' }}" alt=""
                              ...
                              <td class="text-center">{{ $clinic->city }}</td>
